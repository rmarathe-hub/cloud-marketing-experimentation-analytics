...
def test_readme_status_shows_days_1_to_3_complete() -> None:
    readme = read_text(PROJECT_ROOT / "README.md")
...
def test_readme_does_not_claim_day4_complete() -> None:
    readme = read_text(PROJECT_ROOT / "README.md")
    assert "AWS S3 setup + upload | 🔲 Pending" in readme
    assert "AWS S3 setup + upload | ✅ Complete" not in readme
